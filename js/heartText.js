...
export class HeartText {
    ...
    async loadFont(fontName = this.config.fontName) {
        ...
        const fontMap = {
            intertight: 'https://anitamyworld-gamma.vercel.app/assets/fonts/InterTight_Regular.json',
            meow_script: 'https://anitamyworld-gamma.vercel.app/assets/fonts/MeowScript_Regular.json',
            googlesanscode: 'https://anitamyworld-gamma.vercel.app/assets/fonts/GoogleSansCode_Regular.json',
            pacifico: 'https://anitamyworld-gamma.vercel.app/assets/fonts/Pacifico_Regular.json',
            updock: 'https://anitamyworld-gamma.vercel.app/assets/fonts/Updock_Regular.json',
            alumni_sans_pinstripe: 'https://anitamyworld-gamma.vercel.app/assets/fonts/AlumniSansPinstripe_Regular.json',
            dancing_script: 'https://anitamyworld-gamma.vercel.app/assets/fonts/DancingScript.json',
            cormorantunicase: 'https://anitamyworld-gamma.vercel.app/assets/fonts/CormorantUnicase_Regular.json',
        };
