...
export class CentralSphere {
                        ...
                        <div class="section-content" style="display: none; margin-top: 10px;"> 
                            ...
                            <div style="margin-bottom: 12px;">
                                ...
                                <select id="presetAudioSelect" style="width:100%;margin-bottom:8px; padding: 6px; border-radius: 4px; background: #4a4a4a; color: #ffffff; border: 1px solid rgba(255,255,255,0.3); font-size: 0.9em;">
                                    ...
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/massageinabottle.mp3">Massage In A Bottle</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/sombadypleasure.mp3">Sombady Pleasure</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/dandelions.mp3">Dandelions</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/gluesong.mp3">Glue Song</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/oldlove.mp3">Old Love</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/perfect.mp3">Perfect</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/herewithme.mp3">Here With Me</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/givemeyourforever.mp3">Give Me Your Forever</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/wannabeyours.mp3">Wanna Be Yours</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/stuckwithyou.mp3">Stuck With You</option>
                                    <option value="https://anitamyworld-gamma.vercel.app/assets/musics/untilifoundyou.mp3">Until I Found You</option>
            ...
            if (hash.startsWith('#id=')) {
                    ...
                    .then(data => {
                        ...
                        if (data.success && data.config) {
                            ...
                            // Bổ sung:
                                ...
                                window.audioManager.setAudioUrl('https://anitamyworld-gamma.vercel.app/assets/musics/' + data.config.selectedAudioFile);
                            }
                ...
                try {
                    ...
                    // Bổ sung:
                        ...
                        window.audioManager.setAudioUrl('https://anitamyworld-gamma.vercel.app/assets/musics/' + config.selectedAudioFile);
                    }
    ...
    async handleFinishCreation() {
        try {
            ...
            if (!config.audioUrl) {
                config.audioUrl = 'https://anitamyworld-gamma.vercel.app/assets/musics/massageinabottle.mp3';
            }
